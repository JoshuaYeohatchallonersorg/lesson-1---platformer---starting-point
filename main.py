...
bouncePad.set_position(400, 152)
...
def on_forever2():
    if hero.is_hitting_tile(CollisionDirection.BOTTOM) and (hero.tile_kind_at(TileDirection.BOTTOM, sprites.dungeon.hazard_lava0) or hero.tile_kind_at(TileDirection.BOTTOM, sprites.dungeon.hazard_lava1)):
        hero.vy = -80
...
def on_forever3():
    if hero.overlaps_with(bouncePad):
        hero.vy = -250
        bouncePad.set_image(img("""
            ..........bbbbbbbbbbbb..........
                        .......bbb331111333333bbb.......
                        .....cbb3331111113333333bbb.....
                        ....cb33333311113333333111db....
